...
export CONFIG_LOCALVERSION="-Moeニャン"
...
if [ "${DEVICE}" == "S8/S8+" ]; then
	...
	cd ${KERNELDIR}/RAD/Flashable && zip -r9 Moe-${DATE}.zip * -x README.md Moe-${DATE}.zip
	mv Moe-${DATE}.zip ${KERNELDIR}/RAD/Releases/${VERSION}/Moe-${DATE}.zip
